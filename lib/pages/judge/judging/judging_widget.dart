...
import 'judging_model.dart';
export 'judging_model.dart';

class JudgingWidget extends StatefulWidget {
  const JudgingWidget({super.key});

  @override
  State<JudgingWidget> createState() => _JudgingWidgetState();
}

class _JudgingWidgetState extends State<JudgingWidget> {
  late JudgingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JudgingModel());
  }
