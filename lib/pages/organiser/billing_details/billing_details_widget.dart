...
import '/pages/organiser/bottom_sheet_payment/bottom_sheet_payment_widget.dart';
import 'package:flutter/material.dart';
import 'billing_details_model.dart';
export 'billing_details_model.dart';

class BillingDetailsWidget extends StatefulWidget {
  /// page billing for event
...
class _BillingDetailsWidgetState extends State<BillingDetailsWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BillingDetailsModel());
                        ...
                        builder: (context) {
                          return GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: const BottomSheetPaymentWidget(),
                            ),
                          );
                        },
